...
internal class MonitorsPanel : UserControl, IUserEntityView<Monitor>, ISelectableView<Monitor>, ISearchablePanel<Monitor>
{
	...
	private MonitorsExplorerBar monitorsExplorerBar1;
	...
	public List<Monitor> Entities
	{
		...
		set
		{
			Action<Monitor> action1 = null;
			Action<Monitor> action2 = null;
	...
	private MonitorsExplorerBar MonitorsExplorerBar
	{
		get
		{
	...
	[Browsable(false)]
	public SearchTextBox<Monitor> SearchTextBox
	{
		get;
		set;
	}
	...
	public void EnableCommands()
	{
		...
		this.cmdEnabled.Checked = (monitor == null ? 0 : monitor.Enabled).ToInheritableBoolean();
		this.CanClearError = (monitor == null ? 0 : monitor.HasError);
		this.CanClearAllErrors = MonitorSettings.Instance.GetEnumerableMonitors().Any<Monitor>(new Predicate<Monitor>((m) => m.HasError));
	}

	private void EnableMonitor()
	{
		Monitor monitor = this.SelectedItem;
		monitor.Enabled = this.cmdEnabled.Checked == 1;
	}
	...
	private void InitializeComponent()
	{
		...
		this.monitorsExplorerBar1 = new MonitorsExplorerBar();
		...
		this.monitorsExplorerBar1.BeginInit();
		...
		this.uiCommandBar1.Size = new Size(301, 28);
		...
		this.TopRebar1.Size = new Size(301, 28);
		this.monitorsExplorerBar1.BackgroundFormatStyle.BackColor = Color.White;
		this.monitorsExplorerBar1.BorderStyle = BorderStyle.None;
		...
		this.monitorsExplorerBar1.GroupsStateStyles.FormatStyle.BackgroundGradientMode = BackgroundGradientMode.Vertical;
		...
		this.monitorsExplorerBar1.Size = new Size(301, 293);
		...
		this.monitorsExplorerBar1.SpecialGroupsStateStyles.FormatStyle.BackgroundGradientMode = BackgroundGradientMode.Vertical;
		...
		this.monitorsExplorerBar1.add_KeyDown(new KeyEventHandler(this.monitorsExplorerBar1_KeyDown));
		this.monitorsExplorerBar1.add_SelectionChanged(new EventHandler(this.monitorsExplorerBar1_SelectionChanged));
		this.monitorsExplorerBar1.add_MouseDoubleClick(new MouseEventHandler(this.monitorsExplorerBar1_MouseDoubleClick));
		this.monitorsExplorerBar1.add_MouseDown(new MouseEventHandler(this.monitorsExplorerBar1_MouseDown));
		...
		this.panel1.Size = new Size(301, 294);
		...
		this.monitorsExplorerBar1.EndInit();
	...
	private void monitorsExplorerBar1_MouseDoubleClick(object sender, MouseEventArgs e)
	{
		...
		if (this.MonitorsExplorerBar.IsGroupAtLocation(e.Location, ref cancel))
		{
			this.Edit();
			return;
		}
	...
	private void RegisterExplorerBarEvents()
	{
		...
		this.MonitorsExplorerBar.add_ConditionClick(new EventHandler(this.MonitorsExplorerBar_ConditionClick));
		this.MonitorsExplorerBar.add_ActionClick(new EventHandler(this.MonitorsExplorerBar_ActionClick));
		this.MonitorsExplorerBar.add_ErrorClick(new EventHandler(this.MonitorsExplorerBar_ErrorClick));
	}
	...
	private virtual object SVNMonitor.View.Interfaces.ISelectableView<SVNMonitor.Entities.Monitor>.Invoke(Delegate )
	{
		return base.Invoke();
	}

	private void SVNMonitor.View.Interfaces.IUserEntityView<SVNMonitor.Entities.Monitor>.Delete()
	{
	}

	private DialogResult SVNMonitor.View.Interfaces.IUserEntityView<SVNMonitor.Entities.Monitor>.UserEdit(Monitor entity)
	{
	...
	private DialogResult SVNMonitor.View.Interfaces.IUserEntityView<SVNMonitor.Entities.Monitor>.UserNew(Monitor entity)
	{
		...
		{
			EventLog.Log(EventLogEntryType.Monitor, string.Format("Monitor '{0}' created", entity.Name), entity);
		}
		return result;
	}
	...
	{
		this.MonitorsExplorerBar.remove_ConditionClick(new EventHandler(this.MonitorsExplorerBar_ConditionClick));
		this.MonitorsExplorerBar.remove_ActionClick(new EventHandler(this.MonitorsExplorerBar_ActionClick));
		this.MonitorsExplorerBar.remove_ErrorClick(new EventHandler(this.MonitorsExplorerBar_ErrorClick));
	}
