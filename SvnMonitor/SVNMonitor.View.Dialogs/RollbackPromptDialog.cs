...
public class RollbackPromptDialog : BasePromptDialog
{
	...
	private void InitializeComponent()
	{
		...
		this.btnYes.Location = new Point(216, 122);
		this.btnYes.Margin = new Padding(4, 4, 4, 4);
		this.btnYes.Name = "btnYes";
		this.btnYes.Size = new Size(109, 28);
	...
	{
		return RollbackPromptDialog.Prompt(null, revision);
	}
