...
namespace SVNMonitor.Helpers
{
	internal static class FileSystemHelper
	{
		...
		public static void Browse(string path)
		{
			...
			{
				MainForm.FormInstance.ShowErrorMessage(Strings.ErrorPathDoesNotExists_FORMAT.FormatWith(new object[]
				{
					path
				}), Strings.SVNMonitorCaption);
				SVNMonitor.EventLog.LogError(Strings.ErrorPathDoesNotExists_FORMAT.FormatWith(new object[]
				{
					path
				}), path, null);
			}
		...
		public static void DeleteDirectory(string path, bool recursive)
		{
			if (DirectoryExists(path))
			{
				...
				{
					ErrorHandler.Append(Strings.ErrorDeletingDirectory_FORMAT.FormatWith(new object[]
					{
						path
					}), path, ex);
				}
		...
		public static bool DeleteFile(string fileName)
		{
			...
			{
				ErrorHandler.Append(Strings.ErrorDeletingFile_FORMAT.FormatWith(new object[]
				{
					fileName
				}), fileName, ex);
		...
		public static void Explore(string path)
		{
			...
			{
				string error = Strings.ErrorPathDoesNotExists_FORMAT.FormatWith(new object[]
				{
					path
				});
		...
		public static void Open(string path)
		{
			...
			if (Exists(path))
			{
				...
				catch (Win32Exception ex)
				{
					...
					SVNMonitor.EventLog.LogError(Strings.ErrorOpeningPath_FORMAT.FormatWith(new object[]
					{
						path
					}), path, ex);
		...
		public static string AppData
		{
			get
			{
				...
				if (created)
				{
					SVNMonitor.EventLog.LogInfo(Strings.AppDataFolderCreated_FORMAT.FormatWith(new object[]
					{
						path
					}), path);
				}
