...
internal class ActionPropertiesDialog : BaseDialog
{
	...
	private void CreateNewAction()
	{
		...
		Type actionType = this.actionSelector1.SelectedActionType;
		this.action = (Action)Activator.CreateInstance(actionType);
		this.propertyGrid1.SelectedObject = this.action;
	}
	...
	private void InitializeComponent()
	{
		...
		this.actionSelector1.add_SelectedIndexChanged(new EventHandler(this.actionSelector1_SelectedIndexChanged));
